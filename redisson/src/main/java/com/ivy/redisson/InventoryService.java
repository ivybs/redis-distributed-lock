...
public class InventoryService {
    ...
    public String sale(){
        String res = "";
        RLock redisReentryLock = redisson.getLock("zzyyRedisLock");
        ...
        try {
            ...
            // redisson存在bug，就是会去删除别人的Lock,因此要对其进行如下的优化
            if (redisReentryLock.isLocked() && redisReentryLock.isHeldByCurrentThread()){
